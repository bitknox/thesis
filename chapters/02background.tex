...
Connecting the points will form lines, which again can be connected to form polygons that are enclosed shapes (See figure \ref{fig:vector-model}. On the basis of polygons always being closed, we can say that a horizontal line, crossing through the polygon, must intersect an even number of times. This is useful for rasterisation of the vector data.
