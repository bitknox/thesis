...
in the worst case, under the assumptions mentioned. There is therefore at least a theoretical advantage to using our new method, since we think these assumptions are reasonable. The practical advantage is examined in the evaluation section \todo[inline]{add comparison between old methods and new methods for searching \kraster}.
