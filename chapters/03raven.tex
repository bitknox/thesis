...
\paragraph{\kraster} 
In order to efficiently filter values, \ravenjoin needs to be able to quickly retrieve information about all values present in some sub-matrix of the raster data. This is because it is be able to disregard large parts of the raster data if none of the values it contains are matched by the filter.
