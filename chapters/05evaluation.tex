...
To investigate the performance related to the \rtree data structure we test the datasets with a few different \rtree types. Note that there generally are not that many polygons in our dataset (see table \ref{}
