...
\todo[inline]{Cold starts somewhere}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/05evaluation/results/misc/hist_woody.png}
...
\begin{figure}[H]
    ...
    \caption{Join times for filters with different levels of selectivity. \\ \mbox{} \\ \mbox{}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/05evaluation/results/misc/result_creation_time.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=6cm]{images/05evaluation/results/synthetic/Vector Density .png}
...
\todo[inline]{write explanation of memory result}
