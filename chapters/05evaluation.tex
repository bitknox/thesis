...
The selectivity of the filtered joins are small to highlight the efficiency of the algorithm for this case. As listed, the selectivity is set to 0.057\%, 0.059\% and 1.96\% for \textit{GLC2000}, \textit{Treecover} and \textit{Small Woody Features} respectively. \todo[inline]{expand}
